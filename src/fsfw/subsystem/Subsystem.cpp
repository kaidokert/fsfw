...
bool Subsystem::existsModeSequence(Mode_t id) { return modeSequences.exists(id) == RETURN_OK; }

bool Subsystem::existsModeTable(Mode_t id) { return modeTables.exists(id) == RETURN_OK; }
